...
ActiveRecord::Schema[7.0].define(version: 2023_04_01_115041) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "pgcrypto"
  enable_extension "plpgsql"

  create_table "decomps", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
  ...
  create_table "participations", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["decomp_id", "user_id"], name: "index_participations_on_decomp_id_and_user_id", unique: true
    t.index ["decomp_id"], name: "index_participations_on_decomp_id"
