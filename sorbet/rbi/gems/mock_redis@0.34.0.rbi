...
module MockRedis::StringMethods
  ...
  # source://mock_redis//lib/mock_redis/string_methods.rb#300
  ...
  # source://mock_redis//lib/mock_redis/string_methods.rb#337
  ...
  def set(key, value, ex: T.unsafe(nil), px: T.unsafe(nil), nx: T.unsafe(nil), xx: T.unsafe(nil), keepttl: T.unsafe(nil), get: T.unsafe(nil)); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#253
  def setbit(key, offset, value); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#327
  def setex(key, seconds, value); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#347
  def setnx(key, value); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#356
  def setrange(key, offset, value); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#366
  def strlen(key); end

  private

  # source://mock_redis//lib/mock_redis/string_methods.rb#377
  def assert_stringy(key, message = T.unsafe(nil)); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#397
  ...
  # @return [Boolean]
  #
  # source://mock_redis//lib/mock_redis/string_methods.rb#373
  def stringy?(key); end
end
